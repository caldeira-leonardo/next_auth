...
export const fieldTypes = {
  ...
  neighborhood: {
    ...
    options: {
      props: [['required', true], ['placeholder', 'Nome do bairro']]
    }
  },
  ...
  city: {
    ...
    options: {
      props: [['required', true], ['placeholder', 'Nome da cidade']]
    }
  },
  ...
  zipcode: {
    ...
    options: {
      masks: ['cep'],
      props: [['required', true], ['placeholder', '00000-000']]
    }
  },
};
...
export const receipts = {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          options: { ...fieldTypes.email.options, class: 'col-md-6', props: [['required', true], ['type', 'email']] }
        }
      ]
    },
      ...
      items: [
        {
          ...
          options: {
            props: [['required', true], ['placeholder', 'Nome da rua']],
            class: 'col-md-8'
          }
        },
        {
          ...
          options: {
            props: [['required', true], ['placeholder', 'Número']],
            class: 'col-md-4'
          }
        }
      ]
      ...
      items: [
        {
          ...
          field_name: 'message1',
          options: {
            props: [['placeholder', 'Mensagem 1 (opcional)'], ['maxLength', 78]],
            class: 'col-12'
          }
        },
        {
          ...
          field_name: 'message2',
          options: {
            props: [['placeholder', 'Mensagem 2 (opcional)'], ['maxLength', 78]],
            class: 'col-12'
          }
        },
        {
          ...
          field_name: 'message3',
          options: {
            props: [['placeholder', 'Mensagem 3 (opcional)'], ['maxLength', 78]],
            class: 'col-12'
          }
        }
      ]
  ...
  recurring_boleto: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          options: {
            props: [['required', true], ['type', 'number'], ['min', 1], ['max', 60]],
            class: 'col-md-4'
          }
        },
        {
    ...
    // Dados do Pagador (reutiliza do single_boleto)
    {
      input_type: 'container',
      label: 'Dados do Pagador',
      options: { class: 'row mb-4' },
