...
import BoletoModal from '@/components/boletos/boleto-modal';

export default function UnitarioPage() {
  ...
  return (
    <div className='row'>
      <div className='col-12'>
        ...
        <BoletoModal isOpen={isModalOpen} onClose={handleModalClose} onSuccess={handleBoletoCreated} />
      </div>
    </div>
  );
}
